...
Download SE_quick_load_script.ahk and install [AutoHotKey](https://www.autohotkey.com/), then run the script.  It will show up as a systray icon and work in Space Engineers windowedfllscreen mode.  I haven't tested any of the other modes.
